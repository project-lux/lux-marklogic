...
| [read-document-amp.json](/src/main/ml-config/base/security/amps/read-document-amp.json) | [%%mlAppName%%-all-user-profiles-reader](/src/main/ml-config/base/security/roles/6f-all-user-profiles-reader.json) | `_readDocument`, defined in [crudLib.mjs](/src/main/ml-modules/root/lib/crudLib.mjs) |
