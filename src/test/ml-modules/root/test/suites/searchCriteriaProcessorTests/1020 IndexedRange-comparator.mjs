/**
 * Tests IndexedRange.apply() operator validation via requireRangeOperator.
...
const LIB = '1020 IndexedRange-comparator.mjs';
console.log(`${LIB}: starting.`);

let assertions = [];

const pattern = SearchPatternBase.get('indexedRange');

function mockSearchTerm(operator) {
  return {
    getName: () => 'depth',
    getValue: () => '100',
