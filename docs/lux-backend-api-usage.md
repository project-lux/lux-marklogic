...
| `pageLength` | 10 | **OPTIONAL** - The number of results per page. The default is 20. The maximum is 100 for semantic facets and 10000 for non-semantic facest. An error will be thrown if this value is less than 1. |
