# LUX Backend: MarkLogic

Below is a static list of available documentation within the [/docs](/docs) directory.  Additional README files may be found in various directories.  The most notable pertains to database indexing: [/config/README.md](/config/README.md).
...
- [Security and Software](/docs/lux-backend-security-and-software.md)
